...
![Copy the https link of a repo](manual-git/copy-repo-link.png){width=30%}

2. `File > New Project...`, select `Version Control`, choose `Git`
3. Provide the repository HTTPS link, select desired directory

![Clone a repo in RStudio](manual-git/create-project-rstudio.png){width=30%}
...
![Update .gitignore](manual-git/gitignore-rstudio2.png){width=20%}
...
![Local commit](manual-git/commit-rstudio1.png)                            
...
![Local commit](manual-git/commit-rstudio2.png)
...
![Local commit](manual-git/commit-rstudio3.png)
...
![Local commit](manual-git/commit-rstudio4.png)
...
![git pull](manual-git/pull-rstudio.png)
