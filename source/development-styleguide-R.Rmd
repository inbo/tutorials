...
This style guide is a recommendation for all R code written for the Research Institute for Nature and Forest (INBO). It is like to have concequence on the current style used by many R users at INBO. Therefore this style guide should be applied within reason.

1. Don't apply the style guide to existing code.
1. R users have a free choice to apply the style guide to new personal R code.
