...
<ol class="org-ol">
  <li value="  i."> Asks the user for a password on the terminal.</li>
  <li value=" ii."> Opens a (very neat) popup window which asks for password and confirmation, indicating password strength.</li>
  <li value="iii."> Issues a warning that `Password ignored, will be read interactively`.</li>
</ol>
