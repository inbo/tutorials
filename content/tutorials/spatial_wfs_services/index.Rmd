...
This can be done using either [standard OGC filter specification](https://www.ogc.org/standards/filter) or using a [common query language (CQL) filter](https://gcs-docs.s3.amazonaws.com/EVWHS/Miscellaneous/DevGuides/WFS/WFS_Query.htm).
...
First we need to know the names of the fields on which we can filter.
