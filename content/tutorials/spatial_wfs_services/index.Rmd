...
More generally however, when a row of the `MULTISURFACE` object is either a `MULTIPOLYGON` or a `POLYGON` with holes, with the above `st_collection_extract(type = "POLYGON")` this row will be repeated for all constituting polygons, resulting in too many features.
