...
You will find a bit more background about 'why and what', regarding the below open standards, in [a separate post](../../articles/geospatial_standards/) on this website.
...
_Again: you can visit a website of this dataset by just prefixing the DOI string by `doi.org/`!_
