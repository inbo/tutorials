...
![test image](Triturus cristatus_female_4_2025-03-17_106_IMG_9269.JPG)



```{python load-image}
## For testing rotation below, I also flipped the test images to see whether the head direction is good.
...
- You would want to extract the crucial steps and assemble them in a function (see file `ImageProcessingCollection.py`).
