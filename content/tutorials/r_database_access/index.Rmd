...
![odbc-connecties](./data-handling-database-R/odbc_gegevensbron.png)
...
![access-dsn](./data-handling-database-R/access_dsn.png)
...
```{r sqlconnection}
my_connection <- odbcDriverConnect("Driver={ODBC Driver 17 for SQL Server};Server=inbosql04.inbo.be;Database=UserFlora;Trusted_Connection=yes;")
```
