...
Here we provide the approach using the package DBI, which is also used by RStudio and which plays well with dplyr-syntax.^[
...
After installation of the package (`install.packages('DBI')`), the package can be loaded:
