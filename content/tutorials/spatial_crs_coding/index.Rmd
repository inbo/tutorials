...
- a coordinate system,
- a 'datum' (s.l.): it localizes the geodetic coordinate system relative to the Earth and needs a 3D definition of the ellipsoid,
- in case of projected CRSes: coordinate conversion parameters that determine the conversion from the geodetic to the projected coordinates.
