...
`dplyr`/`dbplyr` lack a switch to trigger the `ONLY` keyword, or at least I did not find one.
...
Alternatively, build your tools around direct queries via `DBI`.
{{% /callout %}}
