...
format:
  ...
  hugo-md:
    ...
    preserve_yaml: false
    maths: true
    variant: -tex_math_dollars+tex_math_single_backslash-yaml_metadata_block-pandoc_title_block
---
...
## `<a href="sec-crossdifference"></a>`{=markdown} Cross-Difference {#sec-crossdifference}
...
## `<a href="sec-smoothing"></a>`{=markdown} Simple Smoothing {#sec-smoothing}
...
# `<a href="sec-variograms"></a>`{=markdown} Variograms {#sec-variograms}

## `<a href="sec-detrending"></a>`{=markdown} Debatable "De-Trending" {#sec-detrending}
...
## `<a href="sec-binning"></a>`{=markdown} Beautiful Binning {#sec-binning}
...
# `<a href="sec-model-regression"></a>`{=markdown} Model Regression {#sec-model-regression}
...
## `<a href="sec-gauss"></a>`{=markdown} Beloved Bellcurve {#sec-gauss}
...
## `<a href="sec-matern"></a>`{=markdown} Matérn Machinery {#sec-matern}
...
## `<a href="sec-nodetrend"></a>`{=markdown} De-activated De-trending {#sec-nodetrend}
...
```
`<figcaption>Variogram of the Non-Tobleronian raw data, i.e. random data without spatial relation.</figcaption><br>`{=markdown}
