...
`<a href="sec-crossdifference"></a>`{=markdown} 
...
`<a href="sec-smoothing"></a>`{=markdown} 
...
`<a href="sec-variograms"></a>`{=markdown}

# Variograms {#sec-variograms}


`<a href="sec-detrending"></a>`{=markdown} 
...
`<a href="sec-model-regression"></a>`{=markdown}
...
`<a href="sec-nodetrend"></a>`{=markdown} 
