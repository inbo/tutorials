...
Since the CartoWeb service uses WMS version 1.3.0, we need to override the default version 1.1.1 of `WMSTileOptions()`.
...
Another zoom level triggers the display of another topographic map.
...
```{r fig.cap = "Leaflet map with the orthophoto mosaic as background and a topographic overlay on top"}
leaflet() %>% 
