...
- When decreasing the precision of a position, coordinates are to be _rounded_ while in (UTM and MGRS) grid references the numeric parts representing easting and northing are to be _truncated_.
