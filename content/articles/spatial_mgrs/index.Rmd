...
link-citations: true
csl: '`r cslfile <- file.path("../research-institute-for-nature-and-forest.csl"); download.file("https://github.com/inbo/styles/raw/inbocsl-0.2.0/research-institute-for-nature-and-forest.csl", cslfile); cslfile`'
urlcolor: blue
linkcolor: blue
output: 
  md_document:
...
```{r graticule, fig.cap="'Grid lines' of geographic CRSs are called the graticule. This map still uses the projected CRS 'EPSG:3035' but displays the graticule of geographic CRS 'EPSG:4258' ('ETRS89'), projected in CRS 'EPSG:3035'."}
ggplot(data = countries) +
  geom_sf(fill = "grey97", colour = "grey50") + 
...
In the case of kilometer grid labels, the (anterior) digits _before_ the last two (principal) digits are printed in superscript as they generally don't change within the map.
