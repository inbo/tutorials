...
Authoritative definitions of widely used grids and grid reference systems are not globally coordinated though, contrary to the case of the EPSG-dataset for coordinate reference systems.
...
st_transform(point, "EPSG:25831") |> st_coordinates() |> format(trim = TRUE, nsmall = 3)
```
