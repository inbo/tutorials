...
1. Kopieer het bestand [`Rprofile.site`](Rprofile.site) naar `etc` in de doelmap waar je R geïnstalleerd hebt (`C:\Program Files\R\R-3.x.y`). 
...
Indien dan niet het geval is, volg dan de instructies voor een nieuwe installatie.**
