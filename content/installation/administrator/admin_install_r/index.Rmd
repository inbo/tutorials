...
1. Kopieer het bestand [`Rprofile.site`](https://raw.githubusercontent.com/inbo/tutorials/master/content/installation/administrator/admin_install_r/Rprofile.site) naar `etc` in de doelmap waar je R geïnstalleerd hebt (`C:\Program Files\R\R-3.x.y`) Hierbij moet je het bestaande bestand overschrijven.
